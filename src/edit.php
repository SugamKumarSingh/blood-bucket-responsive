...
$showquery = "select * from organisations where oid='$id1' ";
...
if (isset($_POST['submit'])) {
  ...
  $updatequery = "update organisations set name='$fullname', phone='$phone', email='$email', state='$state', city='$city', description='$msg' where oid=$id1";
...
<body>
  <h1> Edit Organisation Information
  ...
  <div id="contact-form">
    ...
    <form method="POST" action="#">
      ...
      <div>
        <label for="phone">
          <span class="required">Telephone Number: *</span>
          <input type="tel" id="phone" name="phone" value="<?php echo $res['phone']; ?>" placeholder="Telephone Number" tabindex="2" required="required" />
        </label>
      </div>
      <div>
        <label for="email">
      ...
      <div>
        <label for="city">
          <span>City: *</span>
          <input type="text" id="city" name="city" value="<?php echo $res['city']; ?>" placeholder="Your city" tabindex="2" required="required" />
        </label>
      </div>
      <div>
        <label for="message">
          <span class="required">Information regarding organiztion: *</span>
          <textarea id="message" name="message" placeholder="Please Describe in detail." tabindex="5" required="required"><?php echo $res['description']; ?></textarea>
        </label>
      </div>
